<template>
  <div class="team-wrapper">
    ...
    <b-row class="d-flex align-items-center mt-3">
      <b-col md="6">
        <input type="text" placeholder="Buscar" class="common buscar" />
      </b-col>
      <b-col
        md="3"
      ...
      <div class="middle-div">
        <div>
          <div>
            ...
            <span class="team-span">Alfredo zevallos</span>
          </div>
        </div>
        <div>
          <div @click="isName = !isName">
            <i class="fas fa-user-plus"></i>
            <span class="team-span">Marilu fields</span>
            <i class="fas fa-greater-than ms-2"></i>
          </div>
          <div v-if="isName" class="nested-team-span">
            <div>
              <i class="fas fa-user-plus"></i>
              <span class="team-span-n">Marilu fields</span>
            </div>
            <div>
              <i class="fas fa-user-plus"></i>
              <span class="team-span-n">Marilu fields</span>
        ...
        <div>
          <div>
            <i class="fas fa-user-plus"></i>
            <span class="team-span">princess bear</span>
          </div>
        </div>
      </div>
    </div>
